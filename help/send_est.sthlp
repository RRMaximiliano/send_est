...
{* 5 Nov 2019}{...}
{hline}
help for {hi:send_est}
{hline}

{title:Title}

{phang2}{cmdab:send_est} {hline 2} sends estimates to LaTeX or any other file.

{title:Syntax}

{phang2}
{cmdab:send_est} {it:varlist} [{help if:if}] [{help in:in}] [{help weight}]
